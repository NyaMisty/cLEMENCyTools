...
class openrisc_processor_t(processor_t):
    ...
    instruc = instrs = [
        ...
        {'name': 'rli', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Rotate Left Immediate	RLI rA, rB, IMM'},
        {'name': 'rlim', 'feature': CF_USE1 | CF_USE2 | CF_CHG1,
         'cmt': 'Rotate Left Immediate Multi Reg	RLIM rA, rB, IMM'},
        {'name': 'rlm', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Rotate Left Multi Reg	RLM rA, rB, rC'},
        {'name': 'rmp', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Read Memory Protection	RMP rA, rB'},
        {'name': 'rnd', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Random	RND rA'},
        {'name': 'rndm', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Random Multi Reg	RNDM rA'},
        {'name': 'rr', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Rotate Right	RR rA, rB, rC'},
        {'name': 'rri', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Rotate Right Immediate	RRI rA, rB, IMM'},
        {'name': 'rrim', 'feature': CF_USE1 | CF_USE2 | CF_CHG1,
         'cmt': 'Rotate Right Immediate Multi Reg	RRIM rA, rB, rC'},
        {'name': 'rrm', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Rotate Right Multi Reg	RRM rA, rB, rC'},
        {'name': 'sa', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Shift Arithemetic Right	SA rA, rB, rC'},
        {'name': 'sai', 'feature': CF_USE1 | CF_USE2 | CF_CHG1,
         'cmt': 'Shift Arithemetic Right Immediate	SAI rA, rB, IMM'},
        {'name': 'saim', 'feature': CF_USE1 | CF_USE2 | CF_CHG1,
         'cmt': 'Shift Arithemetic Right Immediate Multi Reg	SAIM rA, rB, IMM'},
        {'name': 'sam', 'feature': CF_USE1 | CF_USE2 | CF_CHG1,
         'cmt': 'Shift Arithemetic Right Multi Reg	SAM rA, rB, rC'},
        {'name': 'sb', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Subtract	SB rA, rB, rC'},
        {'name': 'sbc', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Subtract With Carry	SBC rA, rB, rC'},
        {'name': 'sbci', 'feature': CF_USE1 | CF_USE2 | CF_CHG1,
         'cmt': 'Subtract Immediate With Carry	SBCI rA, rB, IMM'},
        {'name': 'sbcim', 'feature': CF_USE1 | CF_USE2 | CF_CHG1,
         'cmt': 'Subtract Immediate Multi Reg With Carry	SBCIM rA, rB, IMM'},
        {'name': 'sbcm', 'feature': CF_USE1 | CF_USE2 | CF_CHG1,
         'cmt': 'Subtract Multi Reg With Carry	SBCM rA, rB, rC'},
        {'name': 'sbf', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Subtract Floating Point	SBF rA, rB, rC'},
        {'name': 'sbfm', 'feature': CF_USE1 | CF_USE2 | CF_CHG1,
         'cmt': 'Subtract Floating Point Multi Reg	SBFM rA, rB, rC'},
        {'name': 'sbi', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Subtract Immediate	SBI rA, rB, IMM'},
        {'name': 'sbim', 'feature': CF_USE1 | CF_USE2 | CF_CHG1,
         'cmt': 'Subtract Immediate Multi Reg	SBIM rA, rB, IMM'},
        {'name': 'sbm', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Subtract Multi Reg	SBM rA, rB, rC'},
        ...
        {'name': 'sf', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Set Flags	SF rA'},
        {'name': 'sl', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Shift Left	SL rA, rB, rC'},
        {'name': 'sli', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Shift Left Immediate	SLI rA, rB, IMM'},
        {'name': 'slim', 'feature': CF_USE1 | CF_USE2 | CF_CHG1,
         'cmt': 'Shift Left Immediate Multi Reg	SLIM rA, rB, IMM'},
        {'name': 'slm', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Shift Left Multi Reg	SLM rA, rB, rC'},
        {'name': 'smp', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Set Memory Protection	SMP rA, rB, FLAGS'},
        {'name': 'sr', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Shift Right	SR rA, rB, rC'},
        {'name': 'sri', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Shift Right Immediate	SRI rA, rB, IMM'},
        {'name': 'srim', 'feature': CF_USE1 | CF_USE2 | CF_CHG1,
         'cmt': 'Shift Right Immediate Multi Reg	SRIM rA, rB, IMM'},
        {'name': 'srm', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Shift Right Multi Reg	SRM rA, rB, rC'},
        {'name': 'sts', 'feature': CF_USE1 | CF_USE2 | CF_CHG1,
         'cmt': 'Store Single	STSm rA, [rB + Offset, RegCount]'},
        {'name': 'stt', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Store Tri	STTm rA, [rB + Offset, RegCount]'},
        {'name': 'stw', 'feature': CF_USE1 | CF_USE2 | CF_CHG1,
         'cmt': 'Store Word	STWm rA, [rB + Offset, RegCount]'},
        {'name': 'wt', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Wait	WT'},
        {'name': 'xr', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Xor	XR rA, rB, rC'},
        {'name': 'xri', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Xor Immediate	XRI rA, rB, IMM'},
        {'name': 'xrm', 'feature': CF_USE1 | CF_USE2 | CF_CHG1, 'cmt': 'Xor Multi Reg	XRM rA, rB, rC'},
